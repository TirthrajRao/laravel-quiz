...
@section('content')
    ...
    <div class="container">
		...
		<div class="col-lg-10 offset-lg-1">									
				...
				<form action="{{ route('searchStudentadmin') }}" method="get" id="frmsearch">
					<input type="text" class="search_input" name="searchStudent" id="searchStudent" placeholder="Enter name to search..."><span onclick="frmsearch();" class="form_search"><i class="fa fa-search" aria-hidden="true"></i></span>
				</form>
					<thead>
						<tr class="student_list">
							...
							<th class="headergreen">Year 
								<form action="{{ route('studentListAdmin') }}" method="get">
					...
					<tbody id="studentList">
						...
						<tr>
							...
							<td data-th="Action">								
								<a href="{{ route('userReportadmin',$students['id']) }}"><button style="border: none; background-color: #009975;color: #fff; cursor: pointer;border-radius: 5px;margin: 2px;">Result</button></a>
								<a href="{{ route('getLessonPlanAdmin',$students['id']) }}"><button style="border: none; background-color: #009975;color: #fff; cursor: pointer;border-radius: 5px;margin: 2px;">Lesson Plans</button></a>
							</td>
						</tr>
						@endforeach
					</tbody>

...
<div class="page-min-height" style="background-color: #454d66">
	...
	{!! Form::open(array('id' => 'regForm','url' => 'admin/viewLession3admin/'.$lession_result->id.'/'.$uid,'role' => 'form','enctype' => 'multipart/form-data','files' => true,)) !!}
	...
	<!-- second step start -->
		<div class="tab breck_table">
			...
			<div style="float:right;">
				<a href="{{route('viewLessionadmin',[$lession_result->id,$uid])}}"><button type="button">Previous</button></a>

				...
				<div class="card" style="background-color: #343F4A;">
					<article class="card-group-item">
						<div class="container" style="margin: 20px 0px; color: #fff"> 
							...
							<h4 style="margin: 10px 0px" class="headergreen"> {{$quizTit}} Result: {{$countTrue}} / {{$totalQuestion}} <a href="/quizLeaderboardStudent/{{ $quest->quizid }}" class="btn btn_quiz score_btn" style="float: right;">Score Board</a></h4>	
							@endif 
							@endforeach
						</div>
						@if (count($question) > 0)

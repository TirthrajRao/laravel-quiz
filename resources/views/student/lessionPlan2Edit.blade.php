...
<div class="page-min-height" style="background-color: #454d66">
	...
	{!! Form::open(array('id' => 'regForm','url' => 'updateLesson2/'.$lession_result->id,'role' => 'form','enctype' => 'multipart/form-data','files' => true,)) !!}
	...
	<!-- second step start -->
		<div class="tab breck_table">
			...
			<div style="float:right;">
				<a href="{{route('editLession',$lession_result->id)}}"><button type="button">Previous</button></a>

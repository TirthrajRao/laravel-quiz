...
<div class="page-min-height appearQuiz"  style="background-color: rgb(69, 77, 102)">
  ...
  <h3 style="color: #009975;text-align: center;font-size: 24px;font-weight: 700">
     <?php
        $unit = explode(",",$quiz->title);
  ...
  @foreach($questions as $iteration=>$question)
    <div class="main">
        ...
        {{ Form::open(array('url' => 'nextClickStudent', 'role' => 'form', 'name' => 'quiz', 'class' => 'form-horizontal', 'id' => 'myForm')) }}
        @else
        {{ Form::open(array('url' => 'finishQuizStudent', 'role' => 'form', 'name' => 'quiz', 'class' => 'form-horizontal', 'id' => 'myForm')) }}
        @endif

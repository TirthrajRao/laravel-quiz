                    ...
                    <div class="inner-container">
                        <div class="card cardHome">
                            <div class="content active">
                                ...
                                <h5>View Detailed Result: <span style="text-decoration: none;color:#fff;font-size: 15px"><a href="/viewSigleResultStudent/{{ $uniqueQuizAppearId }}"> Click here </a></span></h5>
                            </div>
                        </div>
                    </div>
                </section>

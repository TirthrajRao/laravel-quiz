...
<div class="page-min-height" style="background-color: #454d66">
	<section class="all_quiz_list" style="padding: 40px 0px 40px">
		...
		{!! Form::open(array('id' => 'regForm','url' => 'observerLession3/'.$id.'/'.$uid,'role' => 'form','enctype' => 'multipart/form-data','files' => true,)) !!}
		...
		<div class="tab" >
			...
			<textarea rows="8" name="assignment" maxlength="800" class="frmsubmit" readonly="">{{$lession_result->assignment}}</textarea>
